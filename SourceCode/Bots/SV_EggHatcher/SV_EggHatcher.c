/*
Pokemon Scarlet & Violet Egg Hatcher
	...
	switch (state)
	{
		case PROCESS:
			...
			if (commandIndex == -1)
			{
				...
				m_sequence++;
				if (m_sequence == 1 || m_sequence == 5)
				{
					// pick up initial eggs
					commandIndex = 6;
					m_endIndex = 17;
				}
				else if (m_sequence == 2)
				{
					// put eggs to team, exit box
					commandIndex = 23 - (m_columnCount % 6);
					m_endIndex = 29;
				}
				else if (m_sequence == 3)
				{
					// hatch eggs
					commandIndex = 37 - m_eggGroup;
					m_endIndex = 46;
				}
				else if (m_sequence == 4)
				{
					if (m_columnCount >= m_columns - 1)
					{
						// complete
						commandIndex = 3;
						m_endIndex = 4;
				...
				{
					// Put mon back to box
					commandIndex = 58 - (m_columnCount % 6);
					m_endIndex = 61;
					
					m_columnCount++;
				}
				else if (m_sequence == 7)
				{
					if (m_columnCount % 6 > 0)
					{
						// pick up egg on next column
						commandIndex = 5;
						m_endIndex = 17;
