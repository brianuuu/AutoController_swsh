/*
Pokemon Scarlet & Violet Egg Collector
	...
	switch (state)
	{
		case PROCESS:
			...
			if (commandIndex == -1)
			{
				...
				{
					// sandwich is on left or right column?
					commandIndex = m_sandwichX > 0 ? 11 : 12;
					m_endIndex = 12;
					
					// prepare for y movement
					m_posY = 0;
				}
				else if (m_sequence == 3)
				{
					if (m_posY < m_sandwichY)
					{
						// move down until sandwich
						commandIndex = 13;
						m_endIndex = 14;
