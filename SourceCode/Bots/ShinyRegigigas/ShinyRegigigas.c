/*
Pokemon Sword & Shield shiny Regigigas hunting - Proof-of-Concept
		...
		case PROCESS:
			...
			if (commandIndex == -1)
			{
				...
				if (m_shinyAware)
				{
					...
					{
						if (m_usedBerryCount >= m_leppaBerry)
						{
							// Ran out of berries, goto HOME
							commandIndex = 3;
							m_endIndex = 4;
						}
						else
			...
			if (commandIndex == 22) // shiny aware timer
			{
